...
class Smarty_Security {
    ...
    /**
     * This is an array of trusted views classes.
     *
     * If empty access to all views classes is allowed.
    ...
    /**
     * Check if views class is trusted.
     *
     * @param string $class_name
     * @param object $compiler compiler object
     * @return boolean true if class is trusted
     * @throws SmartyCompilerException if views class is not trusted
     */
    public function isTrustedStaticClass($class_name, $compiler)
    {
        ...
        $compiler->trigger_template_error("access to views class '{$class_name}' not allowed by security setting");
        return false; // should not, but who knows what happens to the compiler in the future?
    }
