...
/**
 * Azerbaijani PHPMailer.class language file: refer to English translation for definitive list
 * @package PHPMailer.class
 * @author @mirjalal
 */

$PHPMAILER_LANG['authenticate']         = 'SMTP.class xətası: Giriş uğursuz oldu.';
$PHPMAILER_LANG['connect_host']         = 'SMTP.class xətası: SMTP.class serverinə qoşulma uğursuz oldu.';
$PHPMAILER_LANG['data_not_accepted']    = 'SMTP.class xətası: Verilənlər qəbul edilməyib.';
...
$PHPMAILER_LANG['recipients_failed']    = 'SMTP.class xətası: Aşağıdakı ünvanlar üzrə alıcılara göndərmə uğursuzdur: ';
$PHPMAILER_LANG['signing']              = 'İmzalama xətası: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'SMTP.class serverinə qoşulma uğursuz oldu.';
$PHPMAILER_LANG['smtp_error']           = 'SMTP.class serveri xətası: ';
