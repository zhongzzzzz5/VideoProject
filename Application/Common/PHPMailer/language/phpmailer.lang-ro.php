...
/**
 * Romanian PHPMailer.class language file: refer to English translation for definitive list
 * @package PHPMailer.class
 * @author Alex Florea <alecz.fia@gmail.com>
 */

$PHPMAILER_LANG['authenticate']         = 'Eroare SMTP.class: Autentificarea a eșuat.';
$PHPMAILER_LANG['connect_host']         = 'Eroare SMTP.class: Conectarea la serverul SMTP.class a eșuat.';
$PHPMAILER_LANG['data_not_accepted']    = 'Eroare SMTP.class: Datele nu au fost acceptate.';
...
$PHPMAILER_LANG['recipients_failed']    = 'Eroare SMTP.class: Următoarele adrese de email au eșuat: ';
$PHPMAILER_LANG['signing']              = 'A aparut o problemă la semnarea emailului. ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'Conectarea la serverul SMTP.class a eșuat.';
$PHPMAILER_LANG['smtp_error']           = 'Eroare server SMTP.class: ';
