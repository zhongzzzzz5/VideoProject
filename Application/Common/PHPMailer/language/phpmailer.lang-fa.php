...
/**
 * Persian/Farsi PHPMailer.class language file: refer to English translation for definitive list
 * @package PHPMailer.class
 * @author Ali Jazayeri <jaza.ali@gmail.com>
 * @author Mohammad Hossein Mojtahedi <mhm5000@gmail.com>
 */

$PHPMAILER_LANG['authenticate']         = 'خطای SMTP.class: احراز هویت با شکست مواجه شد.';
$PHPMAILER_LANG['connect_host']         = 'خطای SMTP.class: اتصال به سرور SMTP.class برقرار نشد.';
$PHPMAILER_LANG['data_not_accepted']    = 'خطای SMTP.class: داده‌ها نا‌درست هستند.';
...
$PHPMAILER_LANG['recipients_failed']    = 'خطای SMTP.class: ارسال به آدرس گیرنده با خطا مواجه شد: ';
$PHPMAILER_LANG['signing']              = 'خطا در امضا: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'خطا در اتصال به SMTP.class.';
$PHPMAILER_LANG['smtp_error']           = 'خطا در SMTP.class Server: ';
