...
/**
 * Hebrew PHPMailer.class language file: refer to English translation for definitive list
 * @package PHPMailer.class
 * @author Ronny Sherer <ronny@hoojima.com>
 */

$PHPMAILER_LANG['authenticate']         = 'שגיאת SMTP.class: פעולת האימות נכשלה.';
$PHPMAILER_LANG['connect_host']         = 'שגיאת SMTP.class: לא הצלחתי להתחבר לשרת SMTP.class.';
$PHPMAILER_LANG['data_not_accepted']    = 'שגיאת SMTP.class: מידע לא התקבל.';
...
$PHPMAILER_LANG['recipients_failed']    = 'שגיאת SMTP.class: הנמענים הבאים נכשלו: ';
$PHPMAILER_LANG['signing']              = 'שגיאת חתימה: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'SMTP.class Connect() failed.';
$PHPMAILER_LANG['smtp_error']           = 'שגיאת שרת SMTP.class: ';
