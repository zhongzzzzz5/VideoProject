...
/**
 * Latvian PHPMailer.class language file: refer to English translation for definitive list
 * @package PHPMailer.class
 * @author Eduards M. <e@npd.lv>
 */

$PHPMAILER_LANG['authenticate']         = 'SMTP.class kļūda: Autorizācija neizdevās.';
$PHPMAILER_LANG['connect_host']         = 'SMTP.class Kļūda: Nevar izveidot savienojumu ar SMTP.class serveri.';
$PHPMAILER_LANG['data_not_accepted']    = 'SMTP.class Kļūda: Nepieņem informāciju.';
...
$PHPMAILER_LANG['recipients_failed']    = 'SMTP.class kļūda: neizdevās nosūtīt šādiem saņēmējiem: ';
$PHPMAILER_LANG['signing']              = 'Autorizācijas kļūda: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'SMTP.class savienojuma kļūda';
$PHPMAILER_LANG['smtp_error']           = 'SMTP.class servera kļūda: ';
