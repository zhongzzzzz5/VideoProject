...
/**
 * Belarusian PHPMailer.class language file: refer to English translation for definitive list
 * @package PHPMailer.class
 * @author Aleksander Maksymiuk <info@setpro.pl>
 */

$PHPMAILER_LANG['authenticate']         = 'Памылка SMTP.class: памылка ідэнтыфікацыі.';
$PHPMAILER_LANG['connect_host']         = 'Памылка SMTP.class: нельга ўстанавіць сувязь з SMTP.class-серверам.';
$PHPMAILER_LANG['data_not_accepted']    = 'Памылка SMTP.class: звесткі непрынятыя.';
...
$PHPMAILER_LANG['recipients_failed']    = 'Памылка SMTP.class: няправільныя атрымальнікі: ';
$PHPMAILER_LANG['signing']              = 'Памылка подпісу паведамлення: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'Памылка сувязі з SMTP.class-серверам.';
$PHPMAILER_LANG['smtp_error']           = 'Памылка SMTP.class: ';
