...
/**
 * Malaysian PHPMailer.class language file: refer to English translation for definitive list
 * @package PHPMailer.class
 * @author Nawawi Jamili <nawawi@rutweb.com>
 */

$PHPMAILER_LANG['authenticate']         = 'Ralat SMTP.class: Tidak dapat pengesahan.';
$PHPMAILER_LANG['connect_host']         = 'Ralat SMTP.class: Tidak dapat menghubungi hos pelayan SMTP.class.';
$PHPMAILER_LANG['data_not_accepted']    = 'Ralat SMTP.class: Data tidak diterima oleh pelayan.';
...
$PHPMAILER_LANG['recipients_failed']    = 'Ralat SMTP.class: Penerima e-mel berikut telah gagal: ';
$PHPMAILER_LANG['signing']              = 'Ralat pada tanda tangan: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'SMTP.class Connect() telah gagal.';
$PHPMAILER_LANG['smtp_error']           = 'Ralat pada pelayan SMTP.class: ';
