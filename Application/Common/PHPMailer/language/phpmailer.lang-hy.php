...
/**
 * Armenian PHPMailer.class language file: refer to English translation for definitive list
 * @package PHPMailer.class
 * @author Hrayr Grigoryan <hrayr@bits.am>
 */

$PHPMAILER_LANG['authenticate']         = 'SMTP.class -ի սխալ: չհաջողվեց ստուգել իսկությունը.';
$PHPMAILER_LANG['connect_host']         = 'SMTP.class -ի սխալ: չհաջողվեց կապ հաստատել SMTP.class սերվերի հետ.';
$PHPMAILER_LANG['data_not_accepted']    = 'SMTP.class -ի սխալ: տվյալները ընդունված չեն.';
...
$PHPMAILER_LANG['recipients_failed']    = 'SMTP.class -ի սխալ: չի հաջողվել ուղարկել հետևյալ ստացողների հասցեներին: ';
$PHPMAILER_LANG['signing']              = 'Ստորագրման սխալ: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'SMTP.class -ի connect() ֆունկցիան չի հաջողվել';
$PHPMAILER_LANG['smtp_error']           = 'SMTP.class սերվերի սխալ: ';
