...
/**
 * Bulgarian PHPMailer.class language file: refer to English translation for definitive list
 * @package PHPMailer.class
 * @author Mikhail Kyosev <mialygk@gmail.com>
 */

$PHPMAILER_LANG['authenticate']         = 'SMTP.class грешка: Не може да се удостовери пред сървъра.';
$PHPMAILER_LANG['connect_host']         = 'SMTP.class грешка: Не може да се свърже с SMTP.class хоста.';
$PHPMAILER_LANG['data_not_accepted']    = 'SMTP.class грешка: данните не са приети.';
...
$PHPMAILER_LANG['recipients_failed']    = 'SMTP.class грешка: Следните адреси за Получател са невалидни: ';
$PHPMAILER_LANG['signing']              = 'Грешка при подписване: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'SMTP.class провален connect().';
$PHPMAILER_LANG['smtp_error']           = 'SMTP.class сървърна грешка: ';
