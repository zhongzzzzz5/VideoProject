...
/**
 * Greek PHPMailer.class language file: refer to English translation for definitive list
 * @package PHPMailer.class
 */

$PHPMAILER_LANG['authenticate']         = 'SMTP.class Σφάλμα: Αδυναμία πιστοποίησης (authentication).';
$PHPMAILER_LANG['connect_host']         = 'SMTP.class Σφάλμα: Αδυναμία σύνδεσης στον SMTP.class-Host.';
$PHPMAILER_LANG['data_not_accepted']    = 'SMTP.class Σφάλμα: Τα δεδομένα δεν έγιναν αποδεκτά.';
...
$PHPMAILER_LANG['recipients_failed']    = 'SMTP.class Σφάλμα: Οι παρακάτω διευθύνσεις παραλήπτη δεν είναι έγκυρες: ';
$PHPMAILER_LANG['signing']              = 'Σφάλμα υπογραφής: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'Αποτυχία σύνδεσης στον SMTP.class Server.';
$PHPMAILER_LANG['smtp_error']           = 'Σφάλμα από τον SMTP.class Server: ';
