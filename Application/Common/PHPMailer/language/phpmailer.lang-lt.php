...
/**
 * Lithuanian PHPMailer.class language file: refer to English translation for definitive list
 * @package PHPMailer.class
 * @author Dainius Kaupaitis <dk@sum.lt>
 */

$PHPMAILER_LANG['authenticate']         = 'SMTP.class klaida: autentifikacija nepavyko.';
$PHPMAILER_LANG['connect_host']         = 'SMTP.class klaida: nepavyksta prisijungti prie SMTP.class stoties.';
$PHPMAILER_LANG['data_not_accepted']    = 'SMTP.class klaida: duomenys nepriimti.';
...
$PHPMAILER_LANG['recipients_failed']    = 'SMTP.class klaida: nepavyko išsiųsti šiems gavėjams: ';
$PHPMAILER_LANG['signing']              = 'Prisijungimo klaida: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'SMTP.class susijungimo klaida';
$PHPMAILER_LANG['smtp_error']           = 'SMTP.class stoties klaida: ';
