...
/**
 * Galician PHPMailer.class language file: refer to English translation for definitive list
 * @package PHPMailer.class
 * @author by Donato Rouco <donatorouco@gmail.com>
 */

$PHPMAILER_LANG['authenticate']         = 'Erro SMTP.class: Non puido ser autentificado.';
$PHPMAILER_LANG['connect_host']         = 'Erro SMTP.class: Non puido conectar co servidor SMTP.class.';
$PHPMAILER_LANG['data_not_accepted']    = 'Erro SMTP.class: Datos non aceptados.';
...
$PHPMAILER_LANG['recipients_failed']    = 'Erro SMTP.class: Os seguintes destinos fallaron: ';
$PHPMAILER_LANG['signing']              = 'Erro ó firmar: ';
$PHPMAILER_LANG['smtp_connect_failed']  = 'SMTP.class Connect() fallou.';
$PHPMAILER_LANG['smtp_error']           = 'Erro do servidor SMTP.class: ';
