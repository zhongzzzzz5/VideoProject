...
/**
 * Malagasy PHPMailer.class language file: refer to English translation for definitive list
 * @package PHPMailer.class
 * @author Hackinet <piyushjha8164@gmail.com>
 */

$PHPMAILER_LANG['authenticate']         = 'Hadisoana SMTP.class: Tsy nahomby ny fanamarinana.';
$PHPMAILER_LANG['connect_host']         = 'SMTP.class Error: Tsy afaka mampifandray amin\'ny mpampiantrano SMTP.class.';
$PHPMAILER_LANG['data_not_accepted']    = 'SMTP.class diso: tsy voarakitra ny angona.';
...
$PHPMAILER_LANG['recipients_failed']    = 'SMTP.class Error: Tsy mety ireo mpanaraka ireto: ';
$PHPMAILER_LANG['signing']              = 'Error nandritra ny sonia:';
$PHPMAILER_LANG['smtp_connect_failed']  = 'Tsy nahomby ny fifandraisana tamin\'ny server SMTP.class.';
$PHPMAILER_LANG['smtp_error']           = 'Fahadisoana tamin\'ny server SMTP.class: ';
