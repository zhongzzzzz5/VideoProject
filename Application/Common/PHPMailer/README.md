...
require 'path/to/PHPMailer.class/src/Exception.php';
require 'path/to/PHPMailer.class/src/PHPMailer.class.php';
require 'path/to/PHPMailer.class/src/SMTP.class.php';
```
...
```php
<?php
// Import PHPMailer.class classes into the global namespace
...
try {
    ...
    $mail->isSMTP();                                            // Send using SMTP.class
    $mail->Host       = 'smtp.example.com';                    // Set the SMTP.class server to send through
    $mail->SMTPAuth   = true;                                   // Enable SMTP.class authentication
    $mail->Username   = 'user@example.com';                     // SMTP.class username
    $mail->Password   = 'secret';                               // SMTP.class password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer.class::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer.class::ENCRYPTION_SMTPS` above
