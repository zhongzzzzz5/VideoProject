...
//copyright和备案号
function copyright() {
	$.get(host_url+"index.php/Admin/Index/copyright",function (json) {
...
function donation(){
	layer.tab({
		...
		tab : [{
			...
			title : "QQ",
			content : "<div style='padding:30px;overflow:hidden;background:#d2d0d0;'><img width='200' id='qq-img' src=''></div>"
		}]
	});
	$.get(host_url+"index.php/Admin/Index/copyright",function (json) {
		$("#wx-img").attr("src",json.wx_img);
		$("#qq-img").attr("src",json.qq_img);
	});
}
